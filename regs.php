...
if (!empty($_POST)){
	...
	if ($message ==""){
		...
		$query = " INSERT INTO users (first_name, last_name, email, users_login, users_password, activated, hash) 
		  ...
		  echo  "Ваша заявка на регистрацию принята и будет расмотрена в ближайшее время. <a href='index.php' class='btn btn-link'>Спасибо!</a>";
	}
}
 ...
 <div class="col-md-6 col-md-offset-3"><br /><br />
	...
	<form class="form-horizontal" onSubmit="valid(); return false;" method="POST" id='formregs'>
		...
		<input type="submit" class="btn btn-success" name="button"  value="Регистрация">
			<br />
			<br />
		<input type="reset"  class="btn btn-danger" value="Очистить и начать все сначала"/>
			<br />
			<br />
